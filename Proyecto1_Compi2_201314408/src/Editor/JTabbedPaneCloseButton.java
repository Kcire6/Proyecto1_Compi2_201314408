...
public class JTabbedPaneCloseButton extends JTabbedPane {
    ...
    public void addTab(String title, Component component) {
     ...
     public void addTab(String title, Component component,String dir) {
         super.addTab(title, null , component, null);
        int count = this.getTabCount() - 1;
        CloseButtonTab aux = new CloseButtonTab(component, title, null);
        aux.dir = dir;
        setTabComponentAt(count, aux);
    ...
    public class CloseButtonTab extends JPanel {
        ...
        public CloseButtonTab(final Component tab, String title, Icon icon) {
            ...
            jLabel.setIcon(icon);
            add(jLabel);
            button = new JButton(MetalIconFactory.getInternalFrameCloseIcon(16));
